#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnClientGamePostSimulate skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CLoopModeGame_OnClientPostSimulate"
TARGET_SPECS = [
    {"target_name": "IGameSystem_OnClientGamePostSimulate", "rename_to": "GameSystem_OnClientPostSimulate"},
]
