#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnServerGamePostSimulate skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CLoopModeGame_OnServerPostSimulate"
TARGET_SPECS = [
    {"target_name": "IGameSystem_OnServerGamePostSimulate", "rename_to": "GameSystem_OnServerPostSimulate"},
]
