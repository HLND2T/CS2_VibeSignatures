#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnPostSpawnGroupLoad skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal"
TARGET_SPECS = [
    {
        "target_name": "IGameSystem_OnPostSpawnGroupLoad",
        "rename_to": "GameEvent_PostSpawnGroupLoad",
        "dispatch_rank": 1,
    },
]
