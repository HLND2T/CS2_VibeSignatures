#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_ClientPostDataUpdate skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_ClientPostDataUpdate", "rename_to": "GameSystem_OnClientPostDataUpdate"},
]
