#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnClientPostRender skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CLoopModeGame_OnClientPostOutput"
TARGET_SPECS = [
    {"target_name": "IGameSystem_OnClientPostRender", "rename_to": "GameSystem_OnClientPostRender"},
]
VIA_INTERNAL_WRAPPER = True
INTERNAL_RENAME_TO = "CLoopModeGame_OnClientPostOutputInternal"
MULTI_ORDER = "scan"
