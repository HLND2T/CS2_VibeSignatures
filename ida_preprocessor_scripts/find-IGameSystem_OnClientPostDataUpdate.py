#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnClientPostDataUpdate skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CLoopModeGame_OnPostDataUpdate"
TARGET_SPECS = [
    {"target_name": "IGameSystem_OnClientPostDataUpdate", "rename_to": "GameSystem_OnClientPostDataUpdate"},
]
