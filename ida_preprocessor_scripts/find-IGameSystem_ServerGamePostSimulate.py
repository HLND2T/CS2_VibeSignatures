#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_ServerGamePostSimulate skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_ServerGamePostSimulate", "rename_to": "GameSystem_OnServerPostSimulate"},
]
