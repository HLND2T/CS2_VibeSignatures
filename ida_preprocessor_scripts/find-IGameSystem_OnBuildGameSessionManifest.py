#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnBuildGameSessionManifest skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName"
TARGET_SPECS = [
    {"target_name": "IGameSystem_OnBuildGameSessionManifest", "rename_to": "GameEvent_OnBuildGameSessionManifest"},
]
