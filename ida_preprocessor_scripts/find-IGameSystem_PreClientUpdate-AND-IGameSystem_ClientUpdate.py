...
TARGET_SPECS = [
    {"target_name": "IGameSystem_PreClientUpdate", "rename_to": "GameSystem_OnPreClientUpdate"},
    {"target_name": "IGameSystem_ClientUpdate", "rename_to": "GameSystem_OnClientUpdate"},
]
