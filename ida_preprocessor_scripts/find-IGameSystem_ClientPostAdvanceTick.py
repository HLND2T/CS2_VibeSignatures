#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_ClientPostAdvanceTick skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_ClientPostAdvanceTick", "rename_to": "GameSystem_OnClientPostAdvanceTick"},
]
