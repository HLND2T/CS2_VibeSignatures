...
FUNC_XREFS = [
    {
        ...
        "xref_strings": [
            # Script table key registered only inside ValidatePrivateScriptScope.
            "FULLMATCH:thisEntity",
        ],
...
async def preprocess_skill(
    ...
    """Reuse previous gamever func_sig to locate CEntityInstance::ValidatePrivateScriptScope and write YAML."""
