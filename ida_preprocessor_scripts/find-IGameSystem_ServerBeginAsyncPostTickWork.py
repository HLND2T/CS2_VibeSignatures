#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_ServerBeginAsyncPostTickWork skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_ServerBeginAsyncPostTickWork", "rename_to": "GameSystem_OnServerBeginAsyncPostTickWork"},
]
