#!/usr/bin/env python3
"""Find the Linux LoadSpawnGroup vfunc from request and diagnostic xrefs."""
...
FUNC_XREFS = [
    {
        ...
        "xref_strings": ["No previous spawn group"],
        "xref_gvs": [],
        "xref_signatures": [],
...
async def preprocess_skill(
    ...
    """Resolve the Linux vfunc and retain its vtable slot."""
