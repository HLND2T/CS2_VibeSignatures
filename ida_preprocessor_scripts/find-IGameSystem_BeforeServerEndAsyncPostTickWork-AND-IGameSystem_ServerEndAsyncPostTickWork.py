#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_BeforeServerEndAsyncPostTickWork-AND-IGameSystem_ServerEndAsyncPostTickWork skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_BeforeServerEndAsyncPostTickWork", "rename_to": "GameSystem_OnBeforeServerEndAsyncPostTickWork"},
    {"target_name": "IGameSystem_ServerEndAsyncPostTickWork", "rename_to": "GameSystem_OnServerEndAsyncPostTickWork"},
]
