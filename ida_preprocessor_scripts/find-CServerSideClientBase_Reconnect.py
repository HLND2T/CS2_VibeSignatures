#!/usr/bin/env python3
"""Preprocess script for find-CServerSideClientBase_Reconnect skill."""

from ida_analyze_util import preprocess_common_skill

TARGET_FUNCTION_NAMES = ["CServerSideClientBase_Reconnect"]

FUNC_XREFS = [{
    "func_name": "CServerSideClientBase_Reconnect",
    "xref_strings": ["SV:  Forcing client reconnect (%s) for client '%s'"],
    "xref_gvs": [], "xref_signatures": [], "xref_funcs": [],
    "exclude_funcs": [], "exclude_strings": [], "exclude_gvs": [], "exclude_signatures": [],
}]

FUNC_VTABLE_RELATIONS = [
    ("CServerSideClientBase_Reconnect", "CServerSideClientBase_vtable"),
]

GENERATE_YAML_DESIRED_FIELDS = [(
    "CServerSideClientBase_Reconnect",
