#!/usr/bin/env python3
"""Preprocess script for CEngineServiceMgr's prerequisite-registry vtable."""
...
TARGET_CLASS_NAME = "CEngineServiceMgr"
TARGET_OUTPUT_STEM = "CEngineServiceMgr_vtable2"
CANONICAL_VTABLE_SYMBOLS_BY_PLATFORM = {"linux": TARGET_OUTPUT_STEM}
WINDOWS_SYMBOL_ALIASES = ["??_7CEngineServiceMgr@@6B@_0"]
LINUX_EXPECTED_OFFSET_TO_TOP = -40
