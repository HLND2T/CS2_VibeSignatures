#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_ClientGamePostSimulate skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_ClientGamePostSimulate", "rename_to": "GameSystem_OnClientPostSimulate"},
]
