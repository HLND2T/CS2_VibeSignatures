#!/usr/bin/env python3
"""Preprocess script for find-CLoopModeLevelLoad_LoopInit skill."""
...
FUNC_XREFS = [
    {
        ...
        "xref_strings": ["CLoopModeLevelLoad::LoopInit"],
        "xref_gvs": [],
        "xref_signatures": [],
        "xref_funcs": [],
        "exclude_funcs": [],
...
async def preprocess_skill(
    ...
    """Locate LoopInit from its diagnostic string and vtable relation."""
    _ = skill_name
