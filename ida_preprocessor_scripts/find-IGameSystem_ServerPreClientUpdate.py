#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_ServerPreClientUpdate skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_ServerPreClientUpdate", "rename_to": "GameSystem_OnServerPreClientUpdate"},
]
