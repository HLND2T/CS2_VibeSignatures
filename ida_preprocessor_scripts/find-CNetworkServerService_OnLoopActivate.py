#!/usr/bin/env python3
"""Preprocess script for find-CNetworkServerService_OnLoopActivate skill."""

from ida_analyze_util import preprocess_common_skill

TARGET_FUNCTION_NAMES = ["CNetworkServerService_OnLoopActivate"]
FUNC_XREFS = [{
    "func_name": "CNetworkServerService_OnLoopActivate",
    "xref_strings": ["SV:  Setting game load failed flag."],
    "xref_gvs": [], "xref_signatures": [], "xref_funcs": [],
    "exclude_funcs": [], "exclude_strings": [], "exclude_gvs": [], "exclude_signatures": [],
}]
FUNC_VTABLE_RELATIONS = [("CNetworkServerService_OnLoopActivate", "CNetworkServerService")]
GENERATE_YAML_DESIRED_FIELDS = [("CNetworkServerService_OnLoopActivate", ["func_name", "func_va", "func_rva", "func_size", "func_sig", "vtable_name", "vfunc_offset", "vfunc_index"])]
