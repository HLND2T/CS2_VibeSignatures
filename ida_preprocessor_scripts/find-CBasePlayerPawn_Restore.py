#!/usr/bin/env python3
"""Preprocess script for find-CBasePlayerPawn_Restore skill."""
...
FUNC_XREFS = [
    {
        "func_name": "CBasePlayerPawn_Restore",
        "xref_strings": ["FULLMATCH:%s (%s) removing class relationships due to level transition\n"],
        "xref_gvs": [],
        "xref_signatures": [],
        "xref_funcs": [],
        "exclude_funcs": [],
