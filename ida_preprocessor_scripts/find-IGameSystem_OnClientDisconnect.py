#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnClientDisconnect skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CSource2Client_OnDisconnect"
TARGET_SPECS = [
    {"target_name": "IGameSystem_OnClientDisconnect", "rename_to": "GameSystem_OnDisconnect"},
]
