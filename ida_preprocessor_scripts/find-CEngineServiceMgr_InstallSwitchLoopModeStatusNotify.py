...
TARGET_FUNCTION_NAMES = ["CEngineServiceMgr_InstallSwitchLoopModeStatusNotify"]
LLM_DECOMPILE = [{
    "symbol_name": "CEngineServiceMgr_InstallSwitchLoopModeStatusNotify",
    "prompt_path": "prompt/call_llm_decompile.md",
    "reference_yaml_paths": ["references/engine/CNetworkGameClient_ctor.{platform}.yaml"],
    "expected_result_sections": ["found_vcall"],
    "dependency_policy": {"CNetworkGameClient_ctor.{platform}.yaml": "required"},
}]
FUNC_VTABLE_RELATIONS = [("CEngineServiceMgr_InstallSwitchLoopModeStatusNotify", "CEngineServiceMgr")]
GENERATE_YAML_DESIRED_FIELDS = [("CEngineServiceMgr_InstallSwitchLoopModeStatusNotify", ["func_name", "vfunc_sig", "vfunc_offset", "vfunc_index", "vtable_name"])]
