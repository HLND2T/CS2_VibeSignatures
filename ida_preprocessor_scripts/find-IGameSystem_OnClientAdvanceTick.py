#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnClientAdvanceTick skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CLoopModeGame_OnClientAdvanceTick"
TARGET_SPECS = [
    {"target_name": "IGameSystem_OnClientAdvanceTick", "rename_to": "GameSystem_OnClientAdvanceTick"},
]
