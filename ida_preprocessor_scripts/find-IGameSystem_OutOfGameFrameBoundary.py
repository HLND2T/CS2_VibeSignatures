#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OutOfGameFrameBoundary skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_OutOfGameFrameBoundary", "rename_to": "GameSystem_OnOutOfGameFrameBoundary"},
]
