#!/usr/bin/env python3
"""Preprocess script for find-CGamePlayerEquip_API_TriggerForActivatedPlayer skill."""
...
TARGET_NAME = "CGamePlayerEquip_API_TriggerForActivatedPlayer"
INPUT_NAME = "CGamePlayerEquip_API::TriggerForActivatedPlayer"
HANDLER_PTR_OFFSET = API_INPUT_HANDLER_PTR_OFFSET
ALLOWED_SEGMENT_NAMES = (".data",)
RENAME_TO = "CGamePlayerEquip_API_TriggerForActivatedPlayer"
...
async def preprocess_skill(
    ...
    """Locate the CGamePlayerEquip_API::TriggerForActivatedPlayer input handler from its _API input descriptor."""
