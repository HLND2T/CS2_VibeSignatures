#!/usr/bin/env python3
"""Preprocess script for find-CBaseAnimGraph_vtable skill."""
from ida_analyze_util import preprocess_common_skill
TARGET_CLASS_NAMES = ["CBaseAnimGraph"]
GENERATE_YAML_DESIRED_FIELDS = [("CBaseAnimGraph", ["vtable_class", "vtable_symbol", "vtable_va", "vtable_rva", "vtable_size", "vtable_numvfunc", "vtable_entries"])]
