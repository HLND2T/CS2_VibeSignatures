...
TARGET_FUNCTION_NAMES = ["CEngineServiceMgr_RegisterPrerequisite"]
LLM_DECOMPILE = [{"symbol_name": "CEngineServiceMgr_RegisterPrerequisite", "prompt_path": "prompt/call_llm_decompile.md", "reference_yaml_paths": ["references/engine/CLoopModeLevelLoad_LoopInit.{platform}.yaml"], "expected_result_sections": ["found_vcall"], "dependency_policy": {"CLoopModeLevelLoad_LoopInit.{platform}.yaml": "required"}}]
FUNC_VTABLE_RELATIONS = [("CEngineServiceMgr_RegisterPrerequisite", "CEngineServiceMgr")]
GENERATE_YAML_DESIRED_FIELDS = [("CEngineServiceMgr_RegisterPrerequisite", ["func_name", "vfunc_sig", "vfunc_offset", "vfunc_index", "vtable_name"])]
