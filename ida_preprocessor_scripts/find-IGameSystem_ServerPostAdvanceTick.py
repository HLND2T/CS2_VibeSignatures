#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_ServerPostAdvanceTick skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_ServerPostAdvanceTick", "rename_to": "GameSystem_OnServerPostAdvanceTick"},
]
