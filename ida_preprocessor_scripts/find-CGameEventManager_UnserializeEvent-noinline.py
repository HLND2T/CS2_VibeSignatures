#!/usr/bin/env python3
"""Resolve UnserializeEvent through its standalone helper."""
...
FUNC_XREFS = [
    {
        ...
        "xref_gvs": [],
        "xref_signatures": [],
        "xref_funcs": ["CGameEventManager_UnserializeEventInternal"],
        "exclude_funcs": [],
        "exclude_strings": [],
        "exclude_gvs": [],
        "exclude_signatures": [],
...
async def preprocess_skill(
    ...
    """Resolve the de-inlined path and retain its vtable metadata."""
