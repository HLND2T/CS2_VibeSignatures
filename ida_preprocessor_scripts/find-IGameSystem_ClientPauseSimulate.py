#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_ClientPauseSimulate skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_ClientPauseSimulate", "rename_to": "GameSystem_OnClientPauseSimulate"},
]
