...
TARGET_FUNCTION_NAMES=["INetworkSystem_GetUDPPort"]
LLM_DECOMPILE=[{"symbol_name":"INetworkSystem_GetUDPPort","prompt_path":"prompt/call_llm_decompile.md","reference_yaml_paths":["references/engine/CRConServer_RunFrame.{platform}.yaml"],"expected_result_sections":["found_vcall"],"dependency_policy":{"CRConServer_RunFrame.{platform}.yaml":"required"}}]
FUNC_VTABLE_RELATIONS=[("INetworkSystem_GetUDPPort","INetworkSystem")]
GENERATE_YAML_DESIRED_FIELDS=[("INetworkSystem_GetUDPPort",["func_name","vfunc_sig","vfunc_offset","vfunc_index","vtable_name"])]
