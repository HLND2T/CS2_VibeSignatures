#!/usr/bin/env python3
"""Preprocess script for find-CServerSideClientBase_SetRate skill."""

from ida_analyze_util import preprocess_common_skill

TARGET_FUNCTION_NAMES = ["CServerSideClientBase_SetRate"]

FUNC_XREFS_WINDOWS = [{
    "func_name": "CServerSideClientBase_SetRate",
    "xref_strings": ["Client %d '%s' setting rate to %d"],
    "xref_gvs": [], "xref_signatures": [], "xref_funcs": [],
    "exclude_funcs": [], "exclude_strings": ["FULLMATCH:rate"], "exclude_gvs": [], "exclude_signatures": [],
}]
...
FUNC_XREFS_LINUX = [{
    ...
    "xref_strings": ["Client %d '%s' setting rate to %d"],
    "xref_gvs": [], "xref_signatures": [], "xref_funcs": [],
    "exclude_funcs": [], "exclude_strings": ["FULLMATCH:rate"], "exclude_gvs": [],
    "exclude_signatures": ["55 48 8D 35 24 AD D5 FF"],
}]

FUNC_VTABLE_RELATIONS = [
    ("CServerSideClientBase_SetRate", "CServerSideClientBase_vtable"),
]

GENERATE_YAML_DESIRED_FIELDS = [(
    "CServerSideClientBase_SetRate",
