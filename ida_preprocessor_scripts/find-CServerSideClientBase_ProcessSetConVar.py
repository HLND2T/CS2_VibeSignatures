#!/usr/bin/env python3
"""Preprocess script for find-CServerSideClientBase_ProcessSetConVar skill."""

from ida_analyze_util import preprocess_common_skill

TARGET_FUNCTION_NAMES = ["CServerSideClientBase_ProcessSetConVar"]

FUNC_XREFS = [{
    "func_name": "CServerSideClientBase_ProcessSetConVar",
    "xref_strings": [], "xref_gvs": [], "xref_signatures": [],
    "xref_funcs": ["CServerSideClientBase_ProcessSetConVar_Internal"],
    "exclude_funcs": [], "exclude_strings": ["FULLMATCH:tv_relay"],
    "exclude_gvs": [], "exclude_signatures": [],
}]

FUNC_VTABLE_RELATIONS = [
    ("CServerSideClientBase_ProcessSetConVar", "CServerSideClientBase_vtable"),
]

GENERATE_YAML_DESIRED_FIELDS = [(
    "CServerSideClientBase_ProcessSetConVar",
