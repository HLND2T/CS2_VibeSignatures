#!/usr/bin/env python3
"""Preprocess script for find-CEntitySystem_QueueSpawnEntity-AND-CEntitySystem_ExecuteQueuedCreation-AND-CEntitySystem_m_nExecuteQueuedCreationDepth skill."""
...
async def preprocess_skill(
    ...
    """Reuse previous gamever func_sig/offset_sig to locate target functions and struct offset, write YAMLs."""
