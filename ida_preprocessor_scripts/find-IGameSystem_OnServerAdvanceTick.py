#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnServerAdvanceTick skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CLoopModeGame_OnServerAdvanceTick"
TARGET_SPECS = [
    {"target_name": "IGameSystem_OnServerAdvanceTick", "rename_to": "GameSystem_OnServerAdvanceTick"},
]
