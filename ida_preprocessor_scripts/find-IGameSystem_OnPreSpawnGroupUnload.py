#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_OnPreSpawnGroupUnload skill."""
...
TARGET_SPECS = [
    {"target_name": "IGameSystem_OnPreSpawnGroupUnload", "rename_to": "GameEvent_PreSpawnGroupUnload"},
]
