#!/usr/bin/env python3
"""Preprocess script for find-CConnectGameClient_CheckForResend skill."""

from ida_analyze_util import preprocess_common_skill

TARGET_FUNCTION_NAMES = ["CConnectGameClient_CheckForResend"]
FUNC_XREFS = [{"func_name": "CConnectGameClient_CheckForResend", "xref_strings": ["Sending connect to %s\n"], "xref_gvs": [], "xref_signatures": [], "xref_funcs": [], "exclude_funcs": [], "exclude_strings": [], "exclude_gvs": [], "exclude_signatures": []}]
GENERATE_YAML_DESIRED_FIELDS = [("CConnectGameClient_CheckForResend", ["func_name", "func_sig", "func_va", "func_rva", "func_size"])]
