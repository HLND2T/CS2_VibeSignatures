...
- [follow-up] Remove phase-d-validation.yml, phase_d_validation.py, phase_d_resume.py and temporary helper tests/registration only after PR #926 merges. Keep the executor fix, permanent regression test, handoff and evidence links.
